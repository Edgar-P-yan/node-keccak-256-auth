...
function axiosGetFullUri(config) {
    var requestedURL = axios.getUri(config);
...
var debug = _debug('keccak-256-auth:axios-interceptor');
/**
...
function keccak256AxiosInterceptor(params) {
    ...
    var publicKey = ethUtil.bufferToHex(ethUtil.privateToAddress(privateKey));
